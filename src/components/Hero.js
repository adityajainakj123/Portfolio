...
function Hero() {
   ...
   <h1 className="text-base font-medium tracking-wider ">Welcome to my Personal Website</h1>
                    ...
                    <div className="flex flex-col text-white mt-5">
                        <h1 className="text-4xl md:text-[50px] font-semibold">Hello I'm <span className='glitch' data-text="Aditya">Aditya</span> <span className='glitch'data-text="Kumar">Kumar</span> <span className='glitch'data-text="Jain">Jain</span> </h1>
