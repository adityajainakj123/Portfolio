...
function toggleTopButton() {
  ...
  <i className="fa fa-arrow-up" aria-hidden="true"></i>
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3578.3760221131747!2d78.17195011422213!3d26.249456894647633!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3976c6e5d32a4d53%3A0xf834069adc0c9b89!2sAtal%20Bihari%20Vajpayee%20Indian%20Institute%20of%20Information%20Technology%20and%20Management%20Gwalior!5e0!3m2!1sen!2snl!4v1670930318077!5m2!1sen!2snl" width="100%" height="100%"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        ...
        <div className='footer' style={footercss}>
            ...
            <div className='contactlinks'> 
                <a href="https://www.linkedin.com/in/aditya-kumar-jain-584ba41b8/" className='linkedinlink' target="_blank"><img src={linkedin} className='linkimg'/></a>
                <a href="https://github.com/adityajainakj123" className='linkedinlink'  target="_blank"><img src={github} className='linkimg'/></a>
                <a href="https://www.instagram.com/adi_jain24/" className='linkedinlink'  target="_blank"><img src={instagram} className='linkimg'/></a>
                <a href="https://www.facebook.com/profile.php?id=100074005880329" className='linkedinlink'  target="_blank"><img src={facebook} className='linkimg'/></a>
                <a href="https://linktr.ee/adi24" className='linkedinlink'  target="_blank"><img src={linktree} className='linkimg'/></a>
